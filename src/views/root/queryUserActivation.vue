<template>
  <div style="padding-bottom: 60px;">
    <OnceChange title="root修改" URL="/root/decideChange"></OnceChange>
    ...
    <el-table ref="multipleTableRef" max-height="600px" :data="查询结果.data" style="width: 100%" table-layout="fixed">
      ...
      <el-table-column prop="activation_code" label="激活码" min-width="180px">
        <template #default="{ row }">
          <div class="_code">
            <el-input class="custom-input" v-model="row.activation_code" />
          </div>
        </template>
      </el-table-column>
